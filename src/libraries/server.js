...
export default  {
  ...
  //              "Content-type":"application/json"
    ...
    getSecurityProfile: async function(Token,email_seguridad){
      ...
      console.log(request)
        let response = await fetch(`${api_url}/api/v0/empleado_seguridad/${email_seguridad}`,request)
    ...
    add_incidente: async function(token,body,photo){
        ...
        //  myHeaders.append("Content-Type", "application/x-www-form-urlencoded");
          ...
          formData.append('incident_image',{
            uri:photo.uri,type: 'image/jpeg', name: 'image.jpg'
          })
    ...
    //  console.log(request)
        let response = await fetch(`${api_url}/api/v0/contratista_by_nano_id/${nanoId}`,request)
      //  console.log(response);
        let responseJson = await response.json()
        //console.log(responseJson)
    ...
    getContratistaTimeline: async function(Token,email_contratista){
      ...
      console.log(request)
        let response = await fetch(`${api_url}/api/v0/contratista_timeline/${email_contratista}`,request)
        console.log(response);
        let responseJson = await response.json()
        //console.log(responseJson)
        return responseJson
    ...
    getPlantaTimeline: async function(Token,email_contratista){
      ...
      console.log(request)
        let response = await fetch(`${api_url}/api/v0/planta_timeline/${email_contratista}`,request)
      //  console.log(response);
        let responseJson = await response.json()
        console.log(responseJson)
        return responseJson
